...
// =================================================================
#define NRF24_RF_CH_0           (1 << 0)
#define NRF24_RF_CH_1           (1 << 1)
#define NRF24_RF_CH_2           (1 << 2)
#define NRF24_RF_CH_3           (1 << 3)
#define NRF24_RF_CH_4           (1 << 4)
#define NRF24_RF_CH_5           (1 << 5)
#define NRF24_RF_CH_6           (1 << 6)
...
#define NRF24_STATUS_RX_P_NO    (NRF24_STATUS_RX_P_NO_0 + NRF24_STATUS_RX_P_NO_1 + NRF24_STATUS_RX_P_NO_2)
...
//unsigned char nrf_init_tx(unsigned char channel);
//
//unsigned char nrf_write_register(unsigned char regNo, unsigned char regVal);
//
//void nrf_flush(void);
//
//unsigned char nrf_transmit(unsigned char src[], unsigned char len);
